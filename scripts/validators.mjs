...
const VALID_LEAGUES = [
  ...
  'U18BASEBALLWORLDCUP', 'U15BASEBALLWORLDCUP', 'U23BASEBALLWORLDCUP', 'U18ASIANBASEBALL', 'ASIANGAMESBASEBALL',
];
...
export function validateDataset(games) {
  ...
  const cnt = {
    ...
    U18BASEBALLWORLDCUP: 0, U15BASEBALLWORLDCUP: 0, U23BASEBALLWORLDCUP: 0, U18ASIANBASEBALL: 0, ASIANGAMESBASEBALL: 0,
  };
  for (const g of games) {
