...
export function validateDataset(games) {
  ...
  const cnt = {
    ...
    EFLCUP: 0, WCQUEFA: 0, AMATCHFRIENDLY: 0, HYBRIDFRIENDLY: 0, KOREACUP: 0, WCQAFC: 0, ASIANCUP: 0, U17ASIANCUP: 0, U20ASIANCUP: 0, U23ASIANCUP: 0, WOMENASIANCUP: 0, U20WOMENASIANCUP: 0, AFFCUP: 0, E1MEN: 0, E1WOMEN: 0, KLEAGUESUPERCUP: 0,
  };
  for (const g of games) {
