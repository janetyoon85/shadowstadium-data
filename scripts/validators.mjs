...
const VALID_LEAGUES = [
  ...
  'EFLCUP', 'WCQUEFA', 'AMATCHFRIENDLY', 'HYBRIDFRIENDLY', 'KOREACUP', 'WCQAFC', 'ASIANCUP', 'U17ASIANCUP', 'U20ASIANCUP', 'U23ASIANCUP', 'WOMENASIANCUP', 'U20WOMENASIANCUP', 'AFFCUP', 'E1MEN', 'E1WOMEN', 'KLEAGUESUPERCUP', 'COPAAMERICA', 'CLUBWORLDCUP', 'UEFAEURO', 'U20WORLDCUP', 'U20WOMENWORLDCUP', 'U17WOMENASIANCUP',
];
...
export function validateDataset(games) {
  ...
  const cnt = {
    ...
    EFLCUP: 0, WCQUEFA: 0, AMATCHFRIENDLY: 0, HYBRIDFRIENDLY: 0, KOREACUP: 0, WCQAFC: 0, ASIANCUP: 0, U17ASIANCUP: 0, U20ASIANCUP: 0, U23ASIANCUP: 0, WOMENASIANCUP: 0, U20WOMENASIANCUP: 0, AFFCUP: 0, E1MEN: 0, E1WOMEN: 0, KLEAGUESUPERCUP: 0, COPAAMERICA: 0, CLUBWORLDCUP: 0, UEFAEURO: 0, U20WORLDCUP: 0, U20WOMENWORLDCUP: 0, U17WOMENASIANCUP: 0,
  };
  for (const g of games) {
