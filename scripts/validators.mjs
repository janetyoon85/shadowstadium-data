...
const VALID_LEAGUES = [
  ...
  'U18BASEBALLWORLDCUP', 'U15BASEBALLWORLDCUP', 'U23BASEBALLWORLDCUP', 'U18ASIANBASEBALL', 'ASIANGAMESBASEBALL', 'ASIANGAMESFOOTBALL', 'OLYMPICFOOTBALL',
  'LVBP', 'LIDOM', 'LMP', 'PWL', 'ABL', 'AFL', 'AAA',
  'BRASILEIRAO', 'ARGENTINA', 'LIGAMX', 'PORTUGAL', 'BELGIUM', 'TURKEY', 'GREECE', 'AUSTRIA', 'NORWAY', 'SWEDEN', 'COLOMBIA', 'URUGUAY', 'CHILE', 'CHINA', 'AUSTRALIA',
  'THAILAND', 'INDONESIA', 'INDIA',
  'VENEZUELA', 'ECUADOR', 'PERU', 'BOLIVIA', 'PARAGUAY', 'COSTARICA', 'ELSALVADOR',
  'WALES', 'NORTHERNIRELAND', 'CYPRUS', 'MALTA', 'RUSSIA',
  'MALAYSIA', 'SINGAPORE', 'ISRAEL',
  'SOUTHAFRICA', 'NIGERIA', 'GHANA', 'KENYA', 'UGANDA', 'ZIMBABWE',
];
...
export function validateDataset(games) {
  ...
  const cnt = {
    ...
    U18BASEBALLWORLDCUP: 0, U15BASEBALLWORLDCUP: 0, U23BASEBALLWORLDCUP: 0, U18ASIANBASEBALL: 0, ASIANGAMESBASEBALL: 0, ASIANGAMESFOOTBALL: 0,
    LVBP: 0, LIDOM: 0, LMP: 0, PWL: 0, ABL: 0, AFL: 0, AAA: 0,
  };
  for (const g of games) {
