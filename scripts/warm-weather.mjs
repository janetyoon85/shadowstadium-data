...
// fcm-reminders.yml 5분 cron에 piggyback (별도 워크플로 없음, 2026-09-19부터 15분→5분).
//
// 동작:
...
//     HIT면 0콜. 5분 틱 × 캐시 30분 → upstream은 실질 30분당 1회/구장(틱이 잦아져도 대부분 HIT).
//   · kma-mid는 6h 캐시라 워밍 불필요(스킵).
//
// 쿼터: 최악(13구장 동시 경기) 13구장 × MISS(캐시 30분당 1회) ≈ 9.5h/0.5h ≈ 19회/구장 × 3콜(단기+초단기예보+초단기실황)
//        ≈ 740콜/일 < 한도 10,000의 8%. (윈도우 9.5h·13:00–22:30 기준, 5분 틱으로 바뀌어도 캐시 HIT로 흡수돼 동일.)
